...
(function() {
  var addUnitToRaidFrame, classComplement, classSpecsHandler, classes, complement, defaultUnitFrame, findNextEmptySlot, groupResetHandler, groups, i, invite, inviteHandler, resetInviter, resetInviterHandler, roleHandler, showRoles, specComplement, specRolesHandler, specs, _i;
  ...
  $(function() {
    var group, klass, role, spec, _j, _k, _l, _len, _len1, _len2, _len3, _len4, _m, _n, _ref, _ref1, _results;
    for (_j = 0, _len = classes.length; _j < _len; _j++) {
      klass = classes[_j];
    ...
    for (_n = 0, _len4 = groups.length; _n < _len4; _n++) {
      group = groups[_n];
      _results.push(groupResetHandler(group));
    }
    return _results;
  });
